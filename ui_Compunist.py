...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy.setHeightForWidth(self.generate_score.sizePolicy().hasHeightForWidth())
        self.generate_score.setSizePolicy(sizePolicy)
        self.generate_score.setStyleSheet(u"align: right;")

        self.gridLayout_3.addWidget(self.generate_score, 3, 2, 1, 1)


        self.gridLayout_6.addWidget(self.groupBox_3, 4, 0, 1, 5)
        ...
        self.gridLayout_6.addWidget(self.groupBox_8, 2, 0, 1, 5)
        ...
        sizePolicy1.setHeightForWidth(self.whole_note_slider.sizePolicy().hasHeightForWidth())
        self.whole_note_slider.setSizePolicy(sizePolicy1)
        ...
        self.gridLayout_6.addWidget(self.groupBox_5, 0, 3, 2, 1)
        ...
        self.gridLayout_6.addWidget(self.groupBox_7, 0, 4, 2, 1)
